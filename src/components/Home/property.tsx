      ...
      <div className="property py-15">
        <div className="container">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div data-aos="fade-left" className="right w-1/2 lg:flex lg:flex-col lg:justify-center lg:h-[500px]">
              ...
              <Button className="relative z-1 custom-after rounded-4xl bg-[#14453D] leading-3.5 text-white text-lg border-0 py-6 my-2 cursor-pointer hover:text-white">
