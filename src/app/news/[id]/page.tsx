    ...
    <>
      ...
      <div className="w-full xl:w-[80%] mx-auto">
        <div className="p-3 md:p-10 flex flex-col items-center justify-center">
          <Image
            className="rounded-4xl mb-2 transition-all duration-300 hover:scale-103"
            width={500}
            height={400}
          ...
          <div className="w-full xl:w-[60%] text-center">
            ...
            <p className="text-gray-600 leading-7">{newsItem?.paragraph2}</p>
          </div>
          ...
          {latestNews.map((news) => (
            ...
            >
              <Link href={`/news/${news.id}`}>
                ...
                <Image
                  className="rounded-4xl w-full transition-all duration-300 hover:scale-103"
                  width={600}
                  height={600}
